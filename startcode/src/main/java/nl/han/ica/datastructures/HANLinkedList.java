...
public class HANLinkedList<T> implements IHANLinkedList<T> {
    ...
    public HANLinkedList(HANLinkedListNode<T> firstNode) {
        this.firstNode = firstNode;
    }

    @Override
    public void addFirst(T value) {
        var temp = new HANLinkedListNode<>(value);
    ...
    public HANLinkedListNode<T> getFirstNode() {
        return firstNode;
    }

    private HANLinkedListNode<T> getNoteAtIndex(int index) {
        int counter = 0;
        var current = firstNode;
